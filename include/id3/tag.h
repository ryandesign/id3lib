...
public:
  ...
  */
  ...
  /** Turns unsynchronization on or off, dependant on the value of the boolean
      ...
      details on unsync.  <p> Be default, tags are created without unsync.
  ...
  */
  ...
  /** Turns extended header rendering on or off, dependant on the value of the
      ...
      that support extended headers.  <p> By default, id3lib will generate
      extended headers for all tags in which extended headers are supported.
